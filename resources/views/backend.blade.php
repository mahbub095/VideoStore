                    ...
                    <section class="panel">
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked labels-info ">
                                ...
                                <li>
                                    <a href="#">
                                        <img src="{{asset('backend/img/friends/fr-10.jpg')}}" class="img-circle" width="20">Laura
                                        <p><span class="label label-success">Available</span></p>
                                    </a>
                                </li>
                                <li>
                                    <a href="#">
                                        <img src="{{asset('backend/img/friends/fr-05.jpg')}}" class="img-circle" width="20">David
