					...
					<div class="row hero-area-slide">
						<div class="col-lg-6 col-md-5">
							<div class="hero-area-content">
								<img src="{{asset('frontend/assets/img/slide2.png')}}" alt="about" />
							</div>
						</div>
							...
							<div class="hero-area-content pr-50">
								...
								<div class="slide-cast">
									<div class="single-slide-cast">
										<img src="{{asset('frontend/assets/img/cast/cast1.png')}}" alt="about" />
									</div>
									<div class="single-slide-cast">
										<img src="{{asset('frontend/assets/img/cast/cast2.html')}}" alt="about" />
									</div>
									<div class="single-slide-cast">
									...
									<div class="single-slide-cast">
										<img src="{{asset('frontend/assets/img/cast/cast6.png')}}" alt="about" />
									</div>
									<div class="single-slide-cast">
										<img src="{{asset('frontend/assets/img/cast/cast7.png')}}" alt="about" />
									</div>
                    ...
                    <div class="col-md-3">
                        <div class="row">
                            <div class="col-md-12 col-sm-6">
                                <?php
                                $videos = DB::select('SELECT * FROM videos WHERE filter = "B" ');
